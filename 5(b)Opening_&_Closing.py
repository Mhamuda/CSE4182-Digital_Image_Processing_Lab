...
Opening_img = Erosion(img, se)
Opening_img_f = Dilation(Opening_img, se)

Closing_img = Dilation(img, se)
Closing_img_f = Erosion(Closing_img, se)
...
plt.subplot(1,3,2)
plt.title('Openning image')
plt.imshow(Opening_img_f,cmap='gray')

plt.subplot(1,3,3)
plt.title('Closing image')
plt.imshow(Closing_img_f,cmap='gray')
